...
mergedData <- select(mergedData, patient, seqnames, start, strand, dataSource, GTSP, cellType, timePoint, reads, estAbund, relAbund, nearestFeature, nearestFeatureDist)
names(mergedData) <- c('patient', 'seqnames', 'position', 'strand', 'dataSource', 'internalSampleID', 'cellType', 'timePoint', 'reads', 'estAbund', 'relAbund', 'nearestFeature', 'nearestFeatureDist')
...
illuminaOnlyData <- select(illuminaOnlyData, patient, chromosome, position, strand, dataSource, internalSampleID, cellType, timePoint, reads, estAbund, relAbund, nearestFeature, nearestFeatureDist)
names(illuminaOnlyData) <- c('patient', 'seqnames', 'position', 'strand', 'dataSource', 'internalSampleID', 'cellType', 'timePoint', 'reads', 'estAbund', 'relAbund', 'nearestFeature', 'nearestFeatureDist')
